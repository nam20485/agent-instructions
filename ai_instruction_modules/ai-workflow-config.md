---
description: Configuration for AI workflow tools, patterns, and automation.
...
<xml>
<instructions role="assistant" scope="workflow-config">
...
- **Event Execution:** Check for and execute event scripts at their designated lifecycle points.
...
1.  **Parse** event definitions.
2.  **Execute** events at exact lifecycle point.
3.  **Record** event execution and outputs.
4.  **Gate** on event success.
