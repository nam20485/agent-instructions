...
- The instructions in the Review Current State and the Issues sections and your Memory Tool's ["Current Task Reminder"](./ai-current-task-reminder) can help you with this. Check your "current task reminder" in your memory first to understand your previous context.
